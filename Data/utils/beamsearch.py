...
class Beamsearch(object):
    ...
    def get_current_state(self):
        ...
        #print('number of nodes = ', self.next_nodes[-1])
    ...
    def advance(self, trans_probs):
        ...
        if len(self.prev_Ks) > 0:
            #print('length of prev k = ', len(self.prev_Ks))
        ...
        # Update backpointers
        prev_k = bestScoresId // self.num_nodes  # changed by Enas 
        self.prev_Ks.append(prev_k)
        # Update outputs
        new_nodes = bestScoresId - prev_k * self.num_nodes # Changed by Enas 
        #print('best score id is = ', bestScoresId)
        ...
        self.mask = self.mask.gather(1, perm_mask.type(torch.int64))
    ...
    def update_mask(self, new_nodes):
        ...
        if self.probs_type == 'logits':
            ...
            self.mask[self.mask == 0] = 1e30
        #print('new mask is = ', self.mask)
    def sort_best(self):
        """Sort the beam.
        """
